...
module.exports = (function() {
        ...
        if (_(this).currentReply === '!fatal') { // our last message was a fatal error.
            ...
            if (!more) {
                if (_(this).channels[_(this).currentChannelId]) {
                    _(this).channels[_(this).currentChannelId]._done(_(this).packet, _(this).traps[_(this).currentChannelId]);
                    _(this).currentChannelId = -1;
                }
            }
        } else if (data === '!trap') {
    ...
    Connection.prototype.getCommandPromise = function commandPromise(data, parameters, options) {
        ...
        if (parameters && !Array.isArray(parameters) && (parameters.hasOwnProperty('closeOnDone') || parameters.hasOwnProperty('dontParse') || parameters.dataClass || parameters.itemClass || parameters.itemKey)) {
            options = parameters;
            parameters = null;
        }
        options = options || {};
